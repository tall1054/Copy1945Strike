...
CMonsterBullet5::CMonsterBullet5()
{
}
...
void CMonsterBullet5::Initialize(void)
{
	m_tInfo.fCX = 16.f;
	m_tInfo.fCY = 16.f;
...
int CMonsterBullet5::Update(void)
{
	if (true == m_bDead)
		return OBJ_DEAD;
...
void CMonsterBullet5::Late_Update(void)
{
	if ((WINCY <= m_tInfo.fY))
	{
		m_bDead = true;
...
void CMonsterBullet5::Render(HDC hDC)
{
...
void CMonsterBullet5::Release(void)
{
}
